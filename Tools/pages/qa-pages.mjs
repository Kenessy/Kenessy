...
async function auditHttpSurface(base) {
  ...
  assert((preyJourney.text.match(/data-prey-slot="/g) || []).length === 5, 'Prey journey should expose exactly five visible Prey image slots');
  ...
  assert((preyJourney.text.match(/<div class="evidence-slot[^"]*" data-image-ratio="9:16"/g) || []).length === 2, 'Prey journey should expose exactly two visible 9:16 portrait image frames');
  ...
  assert(preyManifestJson.defaultAspectRatio === '16:9' && Array.isArray(preyManifestJson.slots) && preyManifestJson.slots.length === 6, 'Prey illustrated journal manifest slot contract mismatch');
  assert(preyManifest.text.includes('prey-page-02-a-rooftop-helicopter.png') && preyManifest.text.includes('prey-page-03-a-mimic-paranoia.png') && preyManifest.text.includes('prey-page-03-b-crew-terminal-trace.png') && preyManifest.text.includes('prey-page-04-a-lobby-wrench-mimic.png') && preyManifest.text.includes('prey-page-05-a-office-looking-glass.png') && preyManifest.text.includes('prey-page-06-a-teleconferencing-keycard.png'), 'Prey manifest missing expected filenames');
