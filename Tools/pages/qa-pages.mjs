...
async function auditHttpSurface(base) {
  ...
  assert((preyJourney.text.match(/data-prey-slot="/g) || []).length === 6, 'Prey journey should expose exactly six visible Prey image slots');
  assert((preyJourney.text.match(/<div class="evidence-slot[^"]*" data-image-ratio="16:9"/g) || []).length === 3, 'Prey journey should expose exactly three visible 16:9 image frames');
  assert((preyJourney.text.match(/<div class="evidence-slot[^"]*" data-image-ratio="9:16"/g) || []).length === 3, 'Prey journey should expose exactly three visible 9:16 portrait image frames');
  ...
  assert(preyManifestJson.defaultAspectRatio === '16:9' && Array.isArray(preyManifestJson.slots) && preyManifestJson.slots.length === 7, 'Prey illustrated journal manifest slot contract mismatch');
  ...
  assert(invincible.text.includes('active replay notes') && invincible.text.includes('M-key multicolored map') && invincible.text.includes('Dr. Krauta') && invincible.text.includes('aquarium fish/probe fear') && invincible.text.includes('impossible fried relay'), 'The Invincible report is missing processed replay evidence');
  ...
  assert(invincibleJourney.text.includes('Wake In The Red') && invincibleJourney.text.includes('The Map Earns Trust') && invincibleJourney.text.includes('The Small Choice Matters') && invincibleJourney.text.includes('The Camp Repairs The Timeline') && invincibleJourney.text.includes('The Fish Should Not Know') && invincibleJourney.text.includes('The Camp Finally Acts Back'), 'The Invincible playthrough required processed-replay pages missing');
  assert(invincibleJourney.text.includes('Daniel') && invincibleJourney.text.includes('M-key multicolored map') && invincibleJourney.text.includes('Dr. Krauta') && invincibleJourney.text.includes('fish fear robot probes') && invincibleJourney.text.includes('ordinary sandstorm damage should not explain the relay'), 'The Invincible playthrough is missing processed text/AI-analysis evidence');
  assert(invincibleJourney.text.includes('invincible-page-01-wake-regis.png') && invincibleJourney.text.includes('invincible-page-02-locator-map.png') && invincibleJourney.text.includes('invincible-page-03-sandstorm-ringed-moon.png') && invincibleJourney.text.includes('invincible-page-04-camp-krauta.png') && invincibleJourney.text.includes('invincible-page-05-aquarium-probe-fear.png') && invincibleJourney.text.includes('invincible-page-06-relay-repair.png'), 'The Invincible playthrough image filenames missing');
  ...
  assert(invincibleManifestJson.promptVersion === 'invincible-illustrated-playthrough-v2', 'The Invincible panel manifest prompt version mismatch');
  ...
  assert(invincibleManifest.text.includes('active replay evidence') && invincibleManifest.text.includes('invincible-hero-regis.png') && invincibleManifest.text.includes('invincible-page-05-aquarium-probe-fear.png') && invincibleManifest.text.includes('no fake UI text'), 'The Invincible manifest prompt details missing');
