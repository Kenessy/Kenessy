...
async function auditHttpSurface(base) {
  ...
  assert(preyJourney.text.includes('Fake Morning') && preyJourney.text.includes('Test Rooms') && preyJourney.text.includes('Escape') && preyJourney.text.includes('Art Queue'), 'Prey journey required journal pages missing');
