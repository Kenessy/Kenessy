...
function DiegeticVerdict() {
  ...
  return (
    <aside className="scr-verdict scr-verdict-simple">
      <div className="scr-score-panel scr-score-panel-meter" style={{ '--tone': COLORS.amber }}>
        <div className="scr-score-panel-head"><span>Final Score</span><b>ALERTED</b></div>
        <SignalMeterBlock className="scr-main-score-meter" value={REVIEW.score} color={COLORS.amber} activeRows={activeRows} label="Public Score" note="/100" />
