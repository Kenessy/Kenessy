...
.scr-text-signal{position:relative;isolation:isolate;min-width:0;min-height:106px;overflow:hidden;border:1px solid transparent;background:linear-gradient(148deg,rgba(18,24,33,.96),rgba(9,13,19,.98) 58%,rgba(5,7,11,.99)) padding-box,linear-gradient(135deg,color-mix(in srgb,var(--tone) 74%,#d9c9a3),color-mix(in srgb,var(--tone) 32%,#2a3444) 18%,#26313f 46%,#151b25 100%) border-box;box-shadow:0 14px 32px rgba(0,0,0,.24),inset 0 1px 0 rgba(255,255,255,.045);display:grid;align-content:start;padding:1.05rem 1rem}
...
.scr-text-signal-content{position:relative;z-index:1;display:grid;justify-items:start;gap:.48rem;min-width:0}
.scr-text-signal small{display:inline-block;max-width:100%;border-bottom:2px solid color-mix(in srgb,var(--tone) 72%,transparent);padding-bottom:.22rem;color:var(--tone);font-size:.76rem;font-weight:1000;line-height:1;text-transform:uppercase;letter-spacing:0;text-shadow:0 1px 0 #000,0 0 10px color-mix(in srgb,var(--tone) 26%,transparent)}
