...
@media (min-width:1120px){.scr-hero-grid{min-height:335px;grid-template-areas:"copy verdict";row-gap:0;padding:.5rem 2rem .75rem}.scr-hero-inspect-row{padding:0 2rem .85rem}.scr-hero .scr-score-panel{min-height:326px}.scr-hero .scr-score-panel-simple .scr-main-score-meter{min-height:304px}.scr-hero .scr-main-score-rank{font-size:5.05rem;top:calc(50% + 2.18rem)}}
...
@media (max-width:1119px){.scr-hero-grid{padding-bottom:.65rem}.scr-hero-inspect-row{padding-top:0}.scr-hero .scr-main-score-rank{font-size:5rem;top:calc(50% + 2.25rem)}}
@media (max-width:760px){.scr-identity{font-size:.98rem;line-height:1.56;padding-left:.95rem}.scr-identity::after{display:none}.scr-hero-inspect-row{padding:0 1.1rem 1.1rem}.scr-hero .scr-main-score-rank{font-size:4.65rem;top:calc(50% + 2.1rem)}}
`;
