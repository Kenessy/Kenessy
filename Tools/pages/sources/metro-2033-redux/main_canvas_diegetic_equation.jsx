...
.scr-text-signal small{position:absolute;left:0;top:0;display:inline-block;max-width:100%;border-bottom:2px solid color-mix(in srgb,var(--tone) 72%,transparent);padding-bottom:.24rem;color:var(--tone);font-size:.86rem;font-weight:1000;line-height:1;text-transform:uppercase;letter-spacing:0;text-shadow:0 1px 0 #000,0 0 10px color-mix(in srgb,var(--tone) 26%,transparent)}
.scr-text-signal-main{display:grid;place-items:center;gap:.42rem;min-width:0;text-align:center}
.scr-text-signal b{display:block;color:#decfa8;font-size:.94rem;font-weight:1000;line-height:1.15;text-align:center;text-wrap:balance;text-shadow:0 1px 0 #000}
