      ...
      <div className="scr-insight-board">
        {INSIGHTS.map((row, index) => (
          <article key={row.title} className="scr-insight" style={{ '--tone': row.color }}>
            ...
            <div className="scr-insight-copy"><small>{row.label}</small><h3>{row.title}</h3><p>{row.text}</p></div>
          </article>
        ))}
      </div>
    </section>
...
function getMeterTonePair(color, danger = false) {
  if (danger || color === COLORS.danger) return { onBright: '#3a0506', onDark: '#ff6a5a', lightEdge: 'rgba(255,190,175,.20)', darkEdge: 'rgba(60,0,0,.78)', glow: 'rgba(255,45,31,.48)' };
...
function inactiveMeterRow(color, danger) {
  if (danger || color === COLORS.danger) return '#210304';
...
.scr-meta-rail .scr-meta-chip{gap:.68rem;min-height:2.46rem;border-color:color-mix(in srgb,var(--tone) 52%,#2a3444);background:linear-gradient(180deg,rgba(13,17,23,.96),rgba(7,10,15,.98));box-shadow:inset 0 1px 0 rgba(255,255,255,.05),0 10px 24px rgba(0,0,0,.18);padding:0 .86rem 0 0}.scr-meta-chip::before{background:linear-gradient(120deg,rgba(255,255,255,.075),transparent 38%,rgba(255,255,255,.018) 70%,transparent);opacity:.30}.scr-meta-chip small{align-self:stretch;display:inline-flex;align-items:center;justify-content:center;min-height:0;border:0;border-radius:0;background:linear-gradient(135deg,color-mix(in srgb,var(--tone) 74%,#f2f6ff) 0%,color-mix(in srgb,var(--tone) 60%,#f2f6ff) 48%,color-mix(in srgb,var(--tone) 35%,#0d1117) 84%,color-mix(in srgb,var(--tone) 13%,#0d1117) 100%);padding:0 .72rem;color:#071018;font-size:.64rem;font-weight:1000;line-height:1;text-transform:uppercase;letter-spacing:0;text-shadow:0 1px 0 rgba(255,255,255,.18)}.scr-meta-chip b{background:transparent;color:#decfa8}
...
.scr-inspect-player{justify-self:center;max-width:15.5ch;min-height:3.6rem;color:#9aa7b8;font-size:.76rem;font-weight:760;line-height:1.35;text-wrap:balance}
...
.scr-text-signal{position:relative;isolation:isolate;min-width:0;min-height:116px;overflow:hidden;border:1px solid transparent;background:linear-gradient(315deg,color-mix(in srgb,var(--tone) 15%,transparent) 0%,rgba(255,255,255,.018) 34%,transparent 68%) padding-box,linear-gradient(148deg,rgba(18,24,33,.96),rgba(9,13,19,.98) 58%,rgba(5,7,11,.99)) padding-box,linear-gradient(135deg,color-mix(in srgb,var(--tone) 74%,#d9c9a3),color-mix(in srgb,var(--tone) 32%,#2a3444) 18%,#26313f 46%,#151b25 100%) border-box;box-shadow:0 14px 32px rgba(0,0,0,.24),inset 0 1px 0 rgba(255,255,255,.045);display:grid;align-items:stretch;padding:1rem}
...
.scr-axis-diagnosis .scr-axis-row{border-color:#26313f;background:linear-gradient(135deg,color-mix(in srgb,var(--tone) 6%,transparent),rgba(13,17,23,.98) 36%,rgba(7,10,15,.98));box-shadow:inset 0 0 0 1px rgba(255,255,255,.018)}
.scr-axis-diagnosis .scr-axis-row:hover{background:linear-gradient(135deg,color-mix(in srgb,var(--tone) 8%,transparent),#11161f 42%,#090d13)}
...
.scr-axis-diagnosis .scr-axis-title small{color:color-mix(in srgb,var(--tone) 74%,#8592a5);font-size:.72rem}
...
.scr-axis-diagnosis .scr-axis-title span{margin:0;color:#d9c9a3;font-size:.84rem;font-weight:1000;line-height:1}
...
.scr-insight-module .scr-insight{position:relative;isolation:isolate;display:grid;grid-template-rows:auto 1fr;gap:.9rem;min-width:0;min-height:284px;overflow:hidden;border:1px solid color-mix(in srgb,var(--tone) 46%,#2a3444);background:linear-gradient(315deg,color-mix(in srgb,var(--tone) 10%,transparent),transparent 56%),linear-gradient(145deg,rgba(16,22,30,.96),rgba(7,10,15,.98) 58%,rgba(4,6,10,.99));box-shadow:inset 0 1px 0 rgba(255,255,255,.045),inset 0 0 30px color-mix(in srgb,var(--tone) 7%,transparent);padding:1rem}
...
.scr-insight-index{display:grid;place-items:center;width:3.1rem;height:3.1rem;border:1px solid color-mix(in srgb,var(--tone) 54%,#2a3444);background:linear-gradient(180deg,color-mix(in srgb,var(--tone) 14%,transparent),rgba(0,0,0,.22));color:var(--tone);font-family:ui-monospace,Menlo,monospace;font-size:.86rem;font-weight:1000;line-height:1;text-shadow:0 1px 0 #000,0 0 12px color-mix(in srgb,var(--tone) 24%,transparent)}
.scr-insight-copy{position:relative;display:grid;align-content:start;gap:.65rem;min-width:0}
.scr-insight-module .scr-insight small{color:color-mix(in srgb,var(--tone) 80%,#d9c9a3);font-size:.72rem;font-weight:1000;line-height:1;text-transform:uppercase;letter-spacing:0}
.scr-insight-module .scr-insight h3{margin:0;color:#d9c9a3;font-size:1.7rem;font-weight:1000;line-height:.98;text-transform:uppercase;text-wrap:balance;text-shadow:0 1px 0 #000,0 0 14px color-mix(in srgb,var(--tone) 18%,transparent)}
...
@media (max-width:760px){.scr-insight-module .scr-section-head p{font-size:.98rem}.scr-insight-board{grid-template-columns:1fr}.scr-insight-module .scr-insight{min-height:0;padding:.95rem}.scr-insight-module .scr-insight h3{font-size:1.52rem}.scr-insight-module .scr-insight p{font-size:.9rem}.scr-insight-index{width:2.85rem;height:2.85rem}}
