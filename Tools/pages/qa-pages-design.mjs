...
async function auditDesignArtifacts(base) {
  ...
  assert(preyJourney.text.includes('Fake Morning') && preyJourney.text.includes('Test Rooms') && preyJourney.text.includes('Escape') && preyJourney.text.includes('Office') && preyJourney.text.includes('Looking Glass') && preyJourney.text.includes('Art Queue'), 'Prey journey tab copy is missing');
