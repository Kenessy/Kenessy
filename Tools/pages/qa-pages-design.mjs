...
async function auditViewport(browser, base, buildId, viewport) {
  ...
  const metrics = await page.evaluate(() => {
    ...
    const signalBlocks = {
      ...
      mainScoreLabel: (document.querySelector('.scr-main-score-meter .scr-signal-kicker')?.textContent || '').trim(),
