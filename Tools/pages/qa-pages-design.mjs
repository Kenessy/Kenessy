...
async function auditDesignArtifacts(base) {
  ...
  assert(quantumBreakJourney.text.includes('.comic-spread') && quantumBreakJourney.text.includes('.spread-grid') && quantumBreakJourney.text.includes('grid-template-areas'), 'Quantum Break journey native comic-spread layout is missing');
  ...
  assert(quantumBreakJourney.text.includes('data-qb-slot="page-01-a"') && quantumBreakJourney.text.includes('data-qb-slot="page-02-b"') && quantumBreakJourney.text.includes('data-qb-slot="page-02-d"'), 'Quantum Break journey image slot markers are missing');
  ...
  assert(quantumBreakJourney.text.includes('.brief-grid-spread') && quantumBreakJourney.text.includes('Generation Brief') && quantumBreakJourney.text.includes('qb-page-02-c-core-detonation.png'), 'Quantum Break journey image brief styling is missing');
