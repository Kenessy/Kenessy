...
export function portfolioHomeHtml({
  ...
  const title = 'Kenessy - Systems Design, Adversarial QA, Game Critique';
...
.proof-card,.project-card,.review-card,.hire-card{
  border:1px solid var(--line);
...
.proof-card h3,.project-card h3,.review-copy h3,.hire-card h3{
  color:var(--ink);
  font-size:27px;
  line-height:1.03;
  font-weight:1000;
...
.proof-card p,.project-card p,.review-copy p,.hire-card p{margin-top:10px;color:var(--muted);font-size:15px;line-height:1.55;font-weight:680}
...
@media(max-width:560px){
  ...
  .nav-links{width:100%;justify-content:space-between;gap:4px;flex-wrap:nowrap}
  .nav-links a{min-height:32px;padding:6px 5px;font-size:10px}
  ...
  <section class="section" id="artifacts">
    <div class="wrap">
      <div class="section-head">
        ...
        <p>Different outputs, same operating mode: make the invisible structure visible, then make it durable enough to ship.</p>
      </div>
      <div class="project-grid">
        ...
        <a class="project-card" href="${reportsHref}">
          ...
          <p>A review format where taste-fit, score logic, caveats, and trust evidence are shown instead of hidden behind a single number.</p>
