# The Invincible — Comics / Codex Log

Purpose: track in-game comic/codex entries unlocked during the run and use them as structured lore evidence without relying on external summaries.

Source status: screenshots provided in chat by Daniel. Exact long text should not be copied into public output; use paraphrase.
...
|---|---|---|---|
| **Dragonfly En Route** | Dragonfly is a small research unit of the Interplanetary Commonwealth with a crew of six. The research cycle is ending and the crew expects to head home after one more task. | Establishes crew size, mission type, and calmer pre-crisis baseline. | Unknown whether automatic or collectible. |
...
1. Are comics unlocked automatically at story beats?
2. Are there optional comic panels hidden through exploration?
...
Use these entries as paraphrased lore scaffolding. Avoid long verbatim reproduction of comic text. Public screenshots should show the comic interface as evidence of style and in-game recordkeeping, not replace the review's own summary.
